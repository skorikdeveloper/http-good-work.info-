...
?>
    ...
    <div id="answers-page">
        ...
        <div class="first-block__country">
            ...
            <img src="<?=get_template_directory_uri()?>/img/answers-bg.png" alt="Good Work" class="img-wrapper">
        </div>
        ...
        <div class="answers-content" style="background-image: url('<?=get_template_directory_uri()?>/img/answers-content-bg.png')">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <?php the_content();?>
